...
def spouse_component(features):
    # spouse_string = ""
    spouse_strings = []

    df = pd.read_csv('../data/components/spouse_component.csv')
    key_vals = list(df)
    ...
    for rank in tops:
        ...
        # spouse_string = gen_str
        spouse_strings.append(gen_str)

    return spouse_strings